  ...
  return (
    <div className="max-w-4xl font-sans">
      ...
      <header className="mb-10">
        ...
        <p className="text-text-muted mt-2 text-sm">Manage your API keys and connect your restaurant website to Ramyaios POS.</p>
      </header>
...
We have integrated Ramyaios POS for billing. Whenever a successful order is placed on the website, push it to our POS using the function below.

// Replace with the unique API Key from the POS
const API_KEY = "${apiKeys.length > 0 ? apiKeys[apiKeys.length - 1].key : 'YOUR_API_KEY'}"; 
// The actual domain where Ramyaios POS is hosted
const POS_BASE_URL = "https://knospos.vercel.app"; 

async function sendOrderToRamyaiosPOS(customerInfo, cartItems, totalAmount) {
  try {
...
We have integrated Ramyaios POS for billing. Whenever a successful order is placed on the website, push it to our POS using the function below.`}
            ...
            <div className="text-green-400 mt-2 mb-1">// The actual domain where Ramyaios POS is hosted</div>
            <div>
            ...
            <br />
            <div>
              <span className="text-blue-300">async function</span> <span className="text-yellow-100">sendOrderToRamyaiosPOS</span>(customerInfo, cartItems, totalAmount) {'{'}
            </div>
            <div className="pl-4">
